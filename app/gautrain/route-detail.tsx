...
export default function GautrainRouteDetailScreen() {
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push({ pathname: '/gautrain/route-schedule', params: { routeId } })}
        >
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            ...
            onPress={() => router.push({ pathname: '/gautrain/stop-detail', params: { stopId: item.stop_id } })}
          >
